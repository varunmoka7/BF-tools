...
export function DashboardHeader() {
  ...
  return (
    <div className="glass-card p-6 bg-card border border-border rounded-2xl">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-2xl font-bold text-foreground mb-2">Control Center</h2>
        ...
        <div className="flex items-center space-x-3 mt-4 sm:mt-0">
          <Button 
            ...
            className="glass hover-lift bg-card border-border text-foreground hover:bg-secondary/50 transition-all duration-300"
          >
          ...
          <Button 
            ...
            className="bg-gradient-primary hover:bg-gradient-secondary text-white border-0 hover-lift transition-all duration-300"
          >
