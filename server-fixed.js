...
// API Routes - Order matters! Specific routes must come before parameterized ones
...
// Filter options (must come before parameterized routes)
...
// Individual company profiles (must come before generic companies route)
...
// Company search and filtering (must come last among companies routes)
...
Frontend will be served at the root URL.
Dashboard is now ready at: http://localhost:${PORT}
  `);
});
